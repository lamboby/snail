...
public class ScanWifiService extends Service{
	...
	public void onCreate(){
		super.onCreate();
		Notification notification=new Notification(R.drawable.ic_launcher2,"启动小蜗牛定位服务",System.currentTimeMillis());
		Intent notificationIntent=new Intent(this,MainActivity.class);
		PendingIntent pendingIntent=PendingIntent.getActivity(this, 0, notificationIntent, 0);
		notification.setLatestEventInfo(this, "小蜗牛", "定位点扫描服务程序", pendingIntent);
