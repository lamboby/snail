...
public class Login  extends Activity{
	...
	* */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnLogin.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v){			//登录
		        ...
		        HttpUtil.sendHttpPostRequest("/snail/login", strlogin,new HttpCallbackListener(){
		        	@Override
				...
				if (resObject.getInt("Code")==0){
					...
					{							
						...
						case 2:
							...
							//保存数据
							SharedPreferences.Editor editor=getSharedPreferences("snail",MODE_PRIVATE).edit();
	...
	public void syncstu(String HttpString)
	{
		...
		HttpUtil.sendHttpPostRequest("/snail/sync", HttpString,new HttpCallbackListener()
		{
			@Override
	   		public void onFinish(String response)
			{
